...
function playGame(){
  ...
  computerChoice = rand();
    ...
    display(userChoice + ". Computer chooses " + computerChoice + ". Draw - the only thing worse than losing.");
    currentWinner = "";
    displayScore("Computer: " + scoreBoard.computerScore + "\n You: " + scoreBoard.playerScore + "\n");
  }
  
  else if(computerChoice === options[0]){
    if(userChoice === options[1]){
      display(userChoice + ". Computer chooses " + computerChoice + ". Player Wins");
      scoreBoard.playerScore += 1;
      currentWinner = "player";
      displayScore("Computer: " + scoreBoard.computerScore + "\n You: " + scoreBoard.playerScore + "\n");
      }else{
        display(userChoice + ". Computer chooses " + computerChoice + ". Can't beat a machine")
